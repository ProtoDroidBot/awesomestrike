...
function EFFECT:Render()
	...
	if ct <= self.DieTime then
		...
		self.Entity:SetColor(col.r, col.g, col.b, col.a)
		local ang = self.Entity:GetAngles()
		ang:RotateAroundAxis(ang:Up(), FrameTime() * -600)
		self.Entity:SetAngles(ang)
		self.Entity:SetModelScale(Vector(1 + delta * 4, 1 + delta * 4, 4 - delta * 7))
...
function EFFECT:Init(data)
	...
	WorldSound("ambient/explosions/explode_"..math.random(1,4)..".wav", pos, 75, math.Rand(90, 105))
	...
	self.Entity:SetColor(255, 200, 0, 200)
