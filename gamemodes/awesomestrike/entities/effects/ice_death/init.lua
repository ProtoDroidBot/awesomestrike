...
function EFFECT:Think()
	...
	if ent then
		...
		elseif self.Death < RealTime() then
			...
			for bone = 0, bones do
				...
				if phys and phys:IsValid() then
					...
					for i=1, 12 do
						local particle = emitter:Add("particles/balloon_bit", pos + VectorRand():Normalize() * 2)
						particle:SetVelocity(VectorRand():Normalize() * math.Rand(48, 90))
